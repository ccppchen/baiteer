...
(function ($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		init_controls: function()
		{
			...
			// Controls
			this.$btn_left = this.$container.append('<div class="vmc-arrow-left flex-c-m"><i class="iconfont icon-icon-arrow-left"></i></div>').find('.vmc-arrow-left');
			this.$btn_right = this.$container.append('<div class="vmc-arrow-right flex-c-m"><i class="iconfont icon-icon-arrow-right"></i></div>').find('.vmc-arrow-right');
